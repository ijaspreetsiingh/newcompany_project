...
class BookingDetailsRepo{
  ...
  // ----- AUTO-ASSIGN -----
  Future<Response> toggleAutoAssign() async {
    return await apiClient.putData(AppConstants.autoAssignToggleUrl, {'_method': 'put'});
  }

  Future<Response> updateAutoAssignWaitTime(int seconds) async {
    return await apiClient.putData(AppConstants.autoAssignWaitTimeUrl, {'wait_time': seconds});
  }

  Future<Response> getAutoAssignStatus(String bookingID) async {
