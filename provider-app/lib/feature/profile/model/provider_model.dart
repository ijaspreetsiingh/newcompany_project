...
class ProviderInfo {
  ...
  ProviderInfo.fromJson(Map<String, dynamic> json) {
    ...
    autoAssignMode = int.tryParse(json['auto_assign_mode']?.toString() ?? '0');
    autoAssignWaitTime = int.tryParse(json['auto_assign_wait_time']?.toString() ?? '120');
  ...
  Map<String, dynamic> toJson() {
    ...
    data['auto_assign_mode'] = autoAssignMode;
    data['auto_assign_wait_time'] = autoAssignWaitTime;
    if (owner != null) {
