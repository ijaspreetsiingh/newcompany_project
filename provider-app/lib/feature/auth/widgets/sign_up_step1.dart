...
class SignUpStep1 extends StatefulWidget {
  ...
  const SignUpStep1({super.key, required this.formKey, this.companyEmailFocus, this.companyPhoneFocus});
...
class _SignUpStep1State extends State<SignUpStep1> {
  ...
  late FocusNode _companyPhoneFocus;
  late FocusNode _companyEmailFocus;
  ...
  void initState() {
    super.initState();
    _companyEmailFocus = widget.companyEmailFocus ?? FocusNode();
    _companyPhoneFocus = widget.companyPhoneFocus ?? FocusNode();
  }
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                    ...
                    CustomTextField(
                      ...
                      onValidate: (value){
                        if(value == null || value.isEmpty){
                          ...
                          return signUpController.phoneErrorText;
                        }else{
                    ...
                    CustomTextField(
                      ...
                      onValidate: (value){
                        ...
                        }else if(signUpController.emailErrorText != null){
                          return signUpController.emailErrorText;
                        }else{
