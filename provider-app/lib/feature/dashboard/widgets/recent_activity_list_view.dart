  ...
  Widget build(BuildContext context) {
    return GetBuilder<DashboardController>(
      builder: (dashboardController) {
        return dashboardController.showNormalBooking
                              ...
                              children: [
                                RecentActivityCardItem(
                                  dashboardRecentActivityModel:
                                      dashboardController
                                          .dashboardRecentActivityList[index],
                                ),
                            ...
                            if (index !=
                              ...
                              Padding(
                                ...
                                child: Divider(
                                  height: 1,
                                  color:
                                      Colors.grey[Get.isDarkMode ? 500 : 300],
                                ),
                              ),
                          ],
                        );
            ...
            ? ListView.builder(
                    ...
                    children: [
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CustomImage(
                                ...
                                image:
                                    dashboardController
                                        .dashboardCustomizedPostList[index]
                                        .service
                                        ?.thumbnailFullPath ??
                                    "",
                              ),
                                  ...
                                  Text(
                                    DateConverter.dateMonthYearTime(
                                      DateConverter.isoUtcStringToLocalDate(
                                        "${dashboardController.dashboardCustomizedPostList[index].createdAt}",
                                      ),
                                    ),
                                    style: robotoRegular.copyWith(
                                      fontSize: Dimensions.fontSizeSmall,
                      ...
                      if (index !=
                        ...
                        Padding(
                          ...
                          child: Divider(
                            height: 1,
                            color: Colors.grey[Get.isDarkMode ? 500 : 300],
                          ),
                        ),
                    ],
                  );
                ...
                itemCount:
                    dashboardController.dashboardCustomizedPostList.length,
                physics: const NeverScrollableScrollPhysics(),
                shrinkWrap: true,
              )
            : const Padding(
