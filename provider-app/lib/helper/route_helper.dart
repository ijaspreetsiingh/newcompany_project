...
class RouteHelper {
  ...
  static const String autoAssignSettings = '/auto-assign-settings';
  ...
  static String getAutoAssignSettingsRoute() => autoAssignSettings;
  ...
  static String getIncomingBookingPopupRoute({required String bookingId}) =>
      '$incomingBookingPopup?booking_id=$bookingId';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: autoAssignSettings, page: () => const AutoAssignSettingsScreen()),
