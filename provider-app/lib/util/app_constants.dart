...
class AppConstants {
  ...
  static const String shortAppName = 'JS Provider';
  ...
  // ----- AUTO-ASSIGN -----
  static const String autoAssignToggleUrl = '/api/v1/provider/booking/auto-assign-toggle';
  static const String autoAssignWaitTimeUrl = '/api/v1/provider/booking/auto-assign-wait-time';
  static const String autoAssignStatusUrl = '/api/v1/provider/booking/auto-assign-status';
