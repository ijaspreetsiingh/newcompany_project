...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{translate('Jass Booking Software Installation')}}</h2>
        <h6 class="fw-normal">{{translate('Please proceed step by step with proper data according to instructions')}}</h6>
    </div>

    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Jass Booking Software Installation"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">{{translate('Provide your purchase information to continue')}} </p>
                                ...
                                <div class="from-group">
                                    <label for="username" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                              data-bs-html="true"
                                              data-bs-title="{{translate('Enter your username')}}">
                                                    <img
