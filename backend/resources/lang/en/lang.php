<?php return array (
  ...
  /* AUTO-ASSIGN (provider web panel) */
  'auto_assign_settings' => 'Auto-Assign Settings',
  'auto_assign_mode' => 'Auto-Assign Mode',
  'auto_assign_mode_hint' => 'When ON, all new bookings will come directly to you',
  'booking_wait_time' => 'Booking Wait Time',
  'auto_assign_wait_time_hint' => 'If not accepted within this time, booking moves to the next provider',
  'auto_assign_info_on' => 'Toggle ON: All bookings come to you, timer runs as per your wait time',
  'auto_assign_info_off' => 'Toggle OFF: Booking auto-assigns to the nearest provider in your zone (120 sec default)',
  'auto_assign_info_timeout' => 'When the timer expires, the booking moves to the next available provider',
  ...
  'now_you’ll_be_successfully_able_to_use_the_payment_module_for_your_JDDS_website' => 'Now you’ll be successfully able to use the payment module for your Jass Booking website',
  'N:B you_can_upload_only_JDDS’s_payment_module' => 'N:B you can upload only Jass Booking’s payment module',
  ...
  'After purchasing JDDS from codecanyon. You will find a file download option.' => 'After purchasing Jass Booking from codecanyon. You will find a file download option.',
...
_Message' => 'Customer notification for provider bid offer
 Message',
  ...
  'provider logo' => 'Provider logo',
  'Re Assign' => 'Re Assign',
  'JDDS Software Installation' => 'Jass Booking Software Installation',
...
',
  ...
  'commission to JDDS from each order. You will get access of all the features and options  in store panel , app and interaction with user.' => 'commission to Jass Booking from each order. You will get access of all the features and options  in store panel , app and interaction with user.',
  ...
  'From here, you can configure which types of notifications users receive from JDDS.' => 'From here, you can configure which types of notifications users receive from Jass Booking.',
  'Topics' => 'Topics',
  ...
  'ctype' => 'Ctype',
  'bcmath' => 'Bcmath',
  'Jass Booking Software Installation' => 'Jass Booking Software Installation',
  'curl' => 'Curl',
  'Ex: Jass Booking' => 'Ex: Jass Booking',
  ...
  'page to work notifications.' => 'Page to work notifications.',
  'App_banner_settings' => 'App Setting',
  'Home banner slider settings' => 'Home banner slider settings',
  'Here you can manage the auto slide duration of the home screen banner slider' => 'Here you can manage the auto slide duration of the home screen banner slider',
  'Banner auto slide duration (seconds)' => 'Banner auto slide duration (seconds)',
  'Time in seconds after which the home banner slider will automatically move to the next banner. You can add any number of banners from the Promotions > Banner section, all of them will be shown in the slider.' => 'Time in seconds after which the home banner slider will automatically move to the next banner. You can add any number of banners from the Promotions > Banner section, all of them will be shown in the slider.',
  'App Setting' => 'App Setting',
  'upload_slider_image' => 'Upload slider image',
  'please_upload_slider_image' => 'Please upload slider image',
  'image_size_must_be_less_than_or_equal_to' => 'Image size must be less than or equal to',
