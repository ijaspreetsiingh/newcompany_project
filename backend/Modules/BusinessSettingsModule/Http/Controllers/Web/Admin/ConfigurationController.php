...
class ConfigurationController extends Controller
{
    ...
    /**
     * Display banner slider settings (App Setting section)
     * @return Application|Factory|View
     */
    public function bannerSettingsConfigGet(): View|Factory|Application
    {
     ...
     * @throws AuthorizationException
     */
    public function bannerSettingsConfigSet(Request $request): RedirectResponse
    {
        $this->authorize('configuration_update');
        $request->validate([
            'banner_auto_slide_duration' => 'required|numeric|min:1|max:60',
        ]);

        $liveValues = [
            'banner_auto_slide_duration' => (int)$request['banner_auto_slide_duration'],
        ];

        $this->businessSetting->updateOrCreate(['key_name' => 'banner_slider_settings', 'settings_type' => 'app_settings'], [
            'key_name' => 'banner_slider_settings',
            'live_values' => $liveValues,
            'test_values' => $liveValues,
            'settings_type' => 'app_settings',
            'mode' => 'live',
