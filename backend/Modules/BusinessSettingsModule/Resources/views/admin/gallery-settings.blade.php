                                ...
                                @elseif($file['type']=='file')
                                    <div class=""  title="{{$file['name']}}">
                                        <div class="gallary-card gallary-card-overlay overflow-hidden position-relative initial-25 mb-2">
                                            <img class="initial-26 ratio-1 w-100 mx-auto text-center rounded-2" style="object-fit: contain;" width="150" src="{{$storage == 's3'? rtrim($awsUrl, '/').'/'.ltrim($awsBucket.'/'.$file['path'], '/') : asset('storage/'.$file['path'])}}" alt="{{$file['name']}}">
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    <img src="{{$storage == 's3'? rtrim($awsUrl, '/').'/'.ltrim($awsBucket.'/'.$file['path'], '/') : asset('storage/'.$file['path'])}}"
                            ...
                            <div class="modal fade" id="recentimagemodal{{$recentKey}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            <img src="{{$storage == 's3'? rtrim($awsUrl, '/').'/'.ltrim($awsBucket.'/'.$recentFile['path'], '/') : asset('storage/'.$recentFile['path'])}}"
                                                 class="initial-27 rounded-3 w-auto" >
                                        </div>
                                        <div class="modal-footer justify-content-center border-0 pt-0 gap-lg-3 gap-2">
                                            @can('gallery_export')
