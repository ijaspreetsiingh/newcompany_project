            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @if($webPage == 'app_settings')
                        @php($bannerConfig = business_config('banner_slider_settings', 'app_settings'))
                        @include('businesssettingsmodule::admin.configurations.third-party.banner-settings', ['bannerSettings' => isset($bannerConfig) && isset($bannerConfig->live_values) ? (array)$bannerConfig->live_values : []])
                    @endif
                </div>
            </div>
        </div>
