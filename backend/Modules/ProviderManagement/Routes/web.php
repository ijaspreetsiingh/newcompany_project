...
Route::group(['prefix' => 'provider', 'as' => 'provider.', 'namespace' => 'Web\Provider', 'middleware' => ['provider']], function () {
    ...
    // AUTO-ASSIGN settings (provider web panel)
    Route::get('auto-assign-settings', [ProviderProviderController::class, 'autoAssignSettings'])->name('auto_assign_settings');
    Route::post('auto-assign-settings/update', [ProviderProviderController::class, 'updateAutoAssignSettings'])->name('auto_assign_settings.update');
