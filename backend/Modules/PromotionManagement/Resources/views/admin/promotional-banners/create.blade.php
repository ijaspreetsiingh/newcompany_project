                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex flex-column align-items-center gap-3">
                                                <p class="title-color mb-0">{{translate('upload_slider_image')}}</p>
                                                <div>
    ...
    <script>
        ...
        function validate() {
            ...
            if (!imageInput || !imageInput.files || imageInput.files.length === 0) {
                toastr.error('{{ translate('please_upload_slider_image') }}');
                return false;
            }
            const maxMB = parseFloat(imageInput.dataset.maxfilesize || imageInput.dataset.maxFileSize || '20');
            if (imageInput.files[0].size / (1024 * 1024) > maxMB) {
                toastr.error('{{ translate('image_size_must_be_less_than_or_equal_to') }} ' + maxMB + 'MB');
                return false;
            }
            return true;
        }
