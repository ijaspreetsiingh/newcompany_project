                                                                        ...
                                                                        <div class="bg-white border rounded p-3">
                                                                            <div class="form-check form-switch mb-2">
                                                                                ...
                                                                                <input class="form-check-input" type="checkbox"
                                                                                    ...
                                                                                    {{ old('is_single_provider') == 1 ? 'checked' : '' }}>
                                                                            ...
                                                                            <div id="single-provider-options" class="ps-2 border-start" style="display:none;">
                                                                                <div class="form-check mb-2">
                                                                                    <input class="form-check-input" type="radio"
                                                                                        ...
                                                                                        id="mode-any-first"
                                                                                        onchange="window.__toggleSingleProviderOptions && window.__toggleSingleProviderOptions()"
                                                                                        {{ old('single_provider_mode', 'any_first') == 'any_first' ? 'checked' : '' }}>
                                                                                ...
                                                                                <div class="form-check mb-2">
                                                                                    <input class="form-check-input" type="radio"
                                                                                        ...
                                                                                        id="mode-specific"
                                                                                        onchange="window.__toggleSingleProviderOptions && window.__toggleSingleProviderOptions()"
                                                                                        {{ old('single_provider_mode') == 'specific' ? 'checked' : '' }}>
                                                                                        ...
                                                                                        <select class="form-control" name="single_provider_id" id="single-provider-id">
                                                                                            ...
                                                                                            @foreach(($providers ?? collect()) as $provider)
                                                                                                <option value="{{ $provider->id }}"
                                                                                                    {{ old('single_provider_id') == $provider->id ? 'selected' : '' }}>
            ...
            formWizard.validate({
                ...
                rules: {
                    ...
                    single_provider_mode: {
                        required: {
                            depends: function () {
                                return $('#is-single-provider').is(':checked');
                            }
                        }
                    },
                    single_provider_id: {
                        required: {
                            depends: function () {
                                return $('#is-single-provider').is(':checked') && $('#mode-specific').is(':checked');
                            }
                        }
                    },
                },
                messages: {
                    ...
                    single_provider_mode: "Please select single provider mode",
                    single_provider_id: "Please select a provider",
