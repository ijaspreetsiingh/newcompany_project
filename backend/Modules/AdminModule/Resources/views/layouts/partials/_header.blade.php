                        ...
                        <li class="nav-item max-sm-m-0">
                            <div class="hs-unfold">
                                <div>
                                    ...
                                    @php($lang = \Illuminate\Support\Facades\Cache::remember('sidebar_system_language', 3600, function() { return Modules\BusinessSettingsModule\Entities\BusinessSettings::where('key_name','system_language')->first(); }))
                                    @if ($lang)
