...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin', 'actch:admin_panel']], function () {
    Route::group(['prefix' => 'booking', 'as' => 'booking.'], function () {
        ...
        Route::get('serviceman-location/{booking_id}', [BookingController::class, 'servicemanLocation'])->name('serviceman_location');
    });
});
...
Route::group(['prefix' => 'provider', 'as' => 'provider.', 'namespace' => 'Web\Provider', 'middleware' => ['provider']], function () {
    ...
    Route::group(['prefix' => 'booking', 'as' => 'booking.'], function () {
        ...
        Route::get('serviceman-location/{booking_id}', [ProviderBookingController::class, 'servicemanLocation'])->name('serviceman_location');
    });
});
