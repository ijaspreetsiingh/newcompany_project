...
Route::group(['prefix' => 'provider', 'as' => 'provider.', 'namespace' => 'Api\V1\Provider', 'middleware' => ['auth:api', 'actch:provider_app']], function () {
    Route::group(['prefix' => 'booking', 'as' => 'booking.'], function () {
        ...
        // ----- AUTO-ASSIGN -----
        Route::put('auto-assign-toggle', [ProviderBookingController::class, 'toggleAutoAssign']);
        Route::put('auto-assign-wait-time', [ProviderBookingController::class, 'updateAutoAssignWaitTime']);
        Route::get('auto-assign-status/{booking_id}', [ProviderBookingController::class, 'getAutoAssignStatus']);
...
Route::group(['prefix' => 'serviceman', 'as' => 'serviceman.', 'namespace' => 'Api\V1\Serviceman', 'middleware' => ['auth:api', 'actch:serviceman_app']], function () {
    Route::group(['prefix' => 'booking', 'as' => 'booking.'], function () {
        ...
        Route::put('accept/{booking_id}', [ServicemanBookingController::class, 'acceptBooking']);
        Route::put('reject/{booking_id}', [ServicemanBookingController::class, 'rejectBooking']);
    });
});
