          ...
          children: <Widget>[
            AspectRatio(
              ...
              child: Padding(
                ...
                child: LineChart(mainData(dashboardController)),
              ),
            ),
          ],
        );
      ...
      titlesData: FlTitlesData(
        bottomTitles: AxisTitles(
          sideTitles: SideTitles(
            showTitles: true,
            reservedSize: 32,
            interval: controller.monthlyChartList.length == 31
                ? 3
                : controller.monthlyChartList.length == 32
                ? 4
                : controller.monthlyChartList.length == 30
                ? 3
                : 4,
        ...
        leftTitles: AxisTitles(
          ...
          sideTitles: SideTitles(
            showTitles: true,
            reservedSize: controller.mmM < 100.00
                ? 40
                : controller.mmM < 10000
                ? 45
                : controller.mmM < 100000
                ? 50
                : 55,
          ),
        ),
