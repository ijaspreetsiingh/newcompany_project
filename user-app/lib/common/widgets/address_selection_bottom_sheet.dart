...
import 'package:jdds/common/widgets/custom_highlight_animation_widget.dart';
import 'package:jdds/feature/location/widget/pickmap_dialog_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
       ...
       if(isLoggedIn && (locationController.addressList?.isEmpty ?? true)) SizedBox(
